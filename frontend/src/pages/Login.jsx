...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex selection:bg-indigo-500/30 selection:text-indigo-200 font-sans bg-slate-900">
            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center border-r border-white/5">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-[#0f172a] to-[#040b16]"></div>
                
                {/* Glowing mesh orbs */}
                <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[120px] mix-blend-screen animate-pulse"></div>
                <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-indigo-500/20 rounded-full blur-[120px] mix-blend-screen animate-pulse" style={{ animationDelay: '2s' }}></div>
                ...
                <div className="relative z-10 w-full max-w-lg px-12 xl:px-16 animate-fadeIn text-left">
                    <div className="inline-flex items-center justify-center p-3.5 rounded-2xl bg-white/5 backdrop-blur-md mb-10 border border-white/10 shadow-2xl">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center relative overflow-hidden">
                {/* Right side dark ambient background */}
                <div className="absolute inset-0 bg-[#0a0f1d] z-0"></div>
                ...
                <div className="w-full max-w-[440px] px-6 relative z-10 animate-fadeIn pointer-events-auto">
                    
                    {/* The refined floating dark login card */}
                    <div className="bg-slate-800/40 backdrop-blur-2xl p-10 sm:p-12 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] border border-slate-700/50 flex flex-col justify-center">
                        ...
                        <form onSubmit={handleLogin} className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-[13.5px] font-semibold text-slate-300 tracking-wide">Email Address</label>
                                <input
                                    type="email"
                                    value={email}
                                    ...
                                    required
                                    autoComplete="email"
                                    className="w-full px-4 py-3.5 bg-slate-900/50 backdrop-blur-sm border border-slate-700/80 rounded-xl outline-none transition-all duration-300 shadow-inner text-[14.5px] text-white placeholder:text-slate-500 focus:bg-slate-900 focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 hover:border-slate-600"
                                />
                            </div>

                            {/* Custom Dark Input for Password */}
                            <div className="flex flex-col gap-2">
                                <label className="text-[13.5px] font-semibold text-slate-300 tracking-wide">Password</label>
                                <input
                                    type="password"
                                    value={password}
                            ...
                            <div className="flex items-center justify-between mb-2 mt-1">
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    <input type="checkbox" className="w-[18px] h-[18px] rounded border-slate-600 bg-slate-900 text-indigo-500 focus:ring-indigo-500/30 transition-colors cursor-pointer" />
                                    <span className="text-[14px] font-medium text-slate-400 group-hover:text-slate-200 transition-colors">Remember me</span>
                                </label>
                                <a href="#" className="text-[14px] font-bold text-indigo-400 hover:text-indigo-300 transition-colors">Forgot password?</a>
                            </div>
